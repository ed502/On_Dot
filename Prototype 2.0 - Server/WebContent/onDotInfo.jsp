                ...
                <div class="settings-container">
                    <settings-section>
                        <div id="content" class="content SJ">
                            ...
                            <br>
                            <p style="font-size: 15px;" class="desc">1) 초성 종성 모음 등 다양한 점자를 교육받을 수 있는 어플리케이션 구현 </p>
                            <p style="font-size: 15px;" class="desc">2) 점자퀴즈를 통한 학습효과의 증대</p>
                            <p style="font-size: 15px;" class="desc">3) 점자게시판을 음성으로 이용할 수 있는 기능</p>
                            ...
                            <br>
                            <p style="font-size: 15px;" class="desc">1) 점자를 직접 만지면서 배울 수 있는 점자키트의 구현 </p>
                            <p style="font-size: 15px;" class="desc">2) 최대 8개의 점자까지 확인 가능하므로 짧은 문장단위까지 인식가능</p>
                            <p style="font-size: 15px;" class="desc">3) 큰 점자판으로 확실하게 손으로 전달되는 점자의 느낌을 구현</p>
                            <br>
                            <div class="box box-col01">
                            ...
                            <br>
                            <p style="font-size: 15px;" class="desc">1) 국내 시각 장애인중 86%는 점자 해독이 불가능 </p>
                            <p style="font-size: 15px;" class="desc">2) 시각장애는 95%이상이 후천적으로 발생</p>
                            <p style="font-size: 15px;" class="desc">3) 시각장애인 70%이상이 20세 이후 발생</p>
                            <p style="font-size: 15px;" class="desc">4) 글자에 익숙해진 상황에서 새롭게 점자를 습득하는 데 어려움</p>
                            <br>
                            <div class="box box-col01">
                            ...
                            <br>
                            <p style="font-size: 15px;" class="desc">1) 시각장애인이 혼자서도 학습을 할 수 있도록 시스템을 구성</p>
                            <p style="font-size: 15px;" class="desc">2) 시각장애인이 점자를 직접 체험할 수 있는 점자 키트 개발</p>
                            <p style="font-size: 15px;" class="desc">3) 음성인식을 통해 음성을 점자로 번역하여 점자 키트에서 표현</p>
                            <p style="font-size: 15px;" class="desc">4) 스마트폰 드래그를 통해 점자를 입력하고, 점자를 해독</p>
                            <p style="font-size: 15px;" class="desc">5) 단계별 학습을 통해 자가 학습상태 진단</p>
                            <p style="font-size: 15px;" class="desc">6) 데이터를 수집하여 시각장애인들이 어려움을 느끼는 단어 파악</p>
                        </div>
                    </settings-section>
                </div>
            </div>
