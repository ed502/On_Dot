...
public class EduSecond extends AppCompatActivity implements CustomTouchEventListener {
    ...
    private void setDot() {
        ...
        initDisplaySize();
        initTouchEvent();
        textData = findViewById(R.id.edu2_text);

        circle = new LinearLayout[12];

        circle[0] = findViewById(R.id.edu2_circle1);
        circle[1] = findViewById(R.id.edu2_circle2);
        circle[2] = findViewById(R.id.edu2_circle3);
        circle[3] = findViewById(R.id.edu2_circle4);
        circle[4] = findViewById(R.id.edu2_circle5);
        circle[5] = findViewById(R.id.edu2_circle6);
        circle[6] = findViewById(R.id.edu2_circle7);
        circle[7] = findViewById(R.id.edu2_circle8);
        circle[8] = findViewById(R.id.edu2_circle9);
        circle[9] = findViewById(R.id.edu2_circle10);
    ...
    public void getData() {
        ...
        try {
            URL url = new URL("http://15.165.135.160/DotVowel");
    ...
    public void checkData() {
        ...
        if (list.get(currentLocation).getDot().length() > 6) {
            setContentView(R.layout.edu_second1);
            setDot();
