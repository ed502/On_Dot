...
//종성
public class EduThird extends AppCompatActivity implements CustomTouchEventListener {
    private static final String TAG = "EduThird";
    ...
    private void setDot() {
        ...
        initDisplaySize();
        initTouchEvent();
        textData = findViewById(R.id.edu3_text);

        circle = new LinearLayout[12];

        circle[0] = findViewById(R.id.edu3_circle1);
        circle[1] = findViewById(R.id.edu3_circle2);
        circle[2] = findViewById(R.id.edu3_circle3);
        circle[3] = findViewById(R.id.edu3_circle4);
        circle[4] = findViewById(R.id.edu3_circle5);
        circle[5] = findViewById(R.id.edu3_circle6);
        circle[6] = findViewById(R.id.edu3_circle7);
        circle[7] = findViewById(R.id.edu3_circle8);
        circle[8] = findViewById(R.id.edu3_circle9);
        circle[9] = findViewById(R.id.edu3_circle10);
        circle[10] = findViewById(R.id.edu3_circle11);
        circle[11] = findViewById(R.id.edu3_circle12);
    }
    ...
    public void onOneFingerFunction(final FingerFunctionType fingerFunctionType) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if ((fingerFunctionType == FingerFunctionType.RIGHT) && currentLocation < 26) { //오른쪽에서 왼쪽으로 스크롤
                    currentLocation++;
    ...
    public void getData() {
        ...
        try {
            URL url = new URL("http://15.165.135.160/DotFinal");
    ...
    public void checkData() {
        ...
        if (list.get(currentLocation).getDot().length() > 6) {
            setContentView(R.layout.edu_third1);
            setDot();
