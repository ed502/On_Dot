...
public class QuizSecond extends AppCompatActivity implements CustomTouchEventListener, SensorEventListener {
    ...
    private void setDot() {
        ...
        initDisplaySize();
        initTouchEvent();
        textData = findViewById(R.id.quiz2_text);

        circle = new LinearLayout[6];

        circle[0] = findViewById(R.id.quiz2_circle1);
        circle[1] = findViewById(R.id.quiz2_circle2);
        circle[2] = findViewById(R.id.quiz2_circle3);
        circle[3] = findViewById(R.id.quiz2_circle4);
        circle[4] = findViewById(R.id.quiz2_circle5);
        circle[5] = findViewById(R.id.quiz2_circle6);
    }
